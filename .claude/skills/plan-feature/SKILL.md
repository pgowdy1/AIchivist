...
- Does this need Claude/AI integration, or is it purely data operations?

**If Database is involved:**
- New data to store? Describe the shape (new entity vs new columns on existing).
- Does this affect the FTS5 search index?

**If AI/Search pipeline is involved:**
- Which pass of the search pipeline is affected (expansion, FTS, ranking)?
- New Claude prompt needed, or modification to existing?
...
2. **Installer impact** — Only ask if the feature adds new files, dependencies, or configuration: "Does this affect the desktop installer build?"
